...
public class Classroom {
	...
	public Classroom(int studentsPerTeacher, double percentageOfGirls, double percentageOfBoys, double percentageOfForeigners, int girlsInClass, int boysInClass, int foreignersInClass){
